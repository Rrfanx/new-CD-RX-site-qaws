...
const IDler = {
  botID: "1018588655809482832",
  botSecret: "3QQiURUy8JrRed9v1e6XhkjXQVBio-yQ",
  botCallbackURL: "https://www.rx-cd.ml/callback",
  sunucuID: "1005751810348290080",
  sunucuDavet: "https://discord.gg/JRAcxFRG7e",
  kodLogKanalı: "1020325659060473989",
  sahipRolü: "1005754036521279508",
  adminRolü: "1020746693504933909",
  kodPaylaşımcıRolü: "1020747426061111316",
  boosterRolü: "1005784415374430240",
  kodPaylaşamayacakRoller: ["1024039898157699142"],
  hazırAltyapılarRolü: "1005925260308250734",
  hazırSistemlerRolü: "1005925260308250734",
  sistemlerrolü: "1005754036877795370",
  elmasKodlarRolü: "765467133102391347",
  altınKodlarRolü: "765467136456917003",
  normalKodlarRolü: "1005925260308250734"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod Sayfası", `[Tıkla!](https://www.rx-cd.ml/${obj.kod_rank}/${obj.id})`));
...
client.on("ready", () => {
 ...
 client.user.setActivity(`CD-RX`, { type:"WATCHING" })
